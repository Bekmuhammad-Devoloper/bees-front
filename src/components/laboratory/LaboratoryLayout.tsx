...
export const LaboratoryLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-gray-900">Laboratoriya</span>
            </div>
          )}
          <button
      ...
      >
        <div>
          <h1 className="text-lg font-semibold text-gray-900">Laboratoriya Paneli</h1>
          <p className="text-sm text-gray-500">{user?.name || user?.firstName || 'Laborant'}</p>
        </div>

        <div className="flex items-center gap-4">
          <button className="p-2 hover:bg-gray-100 rounded-lg relative" title="Bildirishnomalar">
